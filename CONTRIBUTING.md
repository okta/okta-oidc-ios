...
In your browser, navigate to: [https://github.com/okta/okta-oidc-ios](https://github.com/okta/okta-oidc-ios)
...
``` bash
$ git clone https://github.com/YOUR_ACCOUNT/okta-oidc-ios.git
$ cd okta-oidc-ios
$ git remote add upstream https://github.com/okta/okta-oidc-ios.git
$ git checkout master
$ git fetch upstream
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/okta-oidc-ios](https://github.com/YOUR_ACCOUNT/okta-oidc-ios)
