...
@protocol OKTExternalUserAgentRequest;
 ...
 */
@protocol OKTExternalUserAgent<NSObject>
...
/*! @brief Presents the request in the external user-agent.
    ...
    @param session The @c OKTExternalUserAgentSession instance that initiates presenting the UI.
        Concrete implementations of a @c OKTExternalUserAgent may call
