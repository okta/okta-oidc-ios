/*! @file OKTExternalUserAgentIOSCustomBrowser.h
 ...
 */
typedef NSURL *_Nullable (^OKTCustomBrowserURLTransformation)(NSURL *_Nullable requestURL);

/*! @brief An implementation of the OKTExternalUserAgent protocol for iOS that uses
 ...
 */
@interface OKTExternalUserAgentIOSCustomBrowser : NSObject<OKTExternalUserAgent>

/*! @brief URL transformation block for the browser.
 */
@property(nonatomic, readonly) OKTCustomBrowserURLTransformation URLTransformation;
...
/*! @brief An instance of @c OKTExternalUserAgentIOSCustomBrowser for Chrome.
 */
+ (instancetype)CustomBrowserChrome;

/*! @brief An instance of @c OKTExternalUserAgentIOSCustomBrowser for Firefox.
 */
+ (instancetype)CustomBrowserFirefox;

/*! @brief An instance of @c OKTExternalUserAgentIOSCustomBrowser for Opera.
 */
+ (instancetype)CustomBrowserOpera;

/*! @brief An instance of @c OKTExternalUserAgentIOSCustomBrowser for Safari.
 */
+ (instancetype)CustomBrowserSafari;

/*! @brief Creates a @c OKTCustomBrowserURLTransformation using the scheme substitution method used
...
/*! @brief Creates a @c OKTCustomBrowserURLTransformation with the URL prefix method used by
...
/*! @brief OKTExternalUserAgent for a custom browser. @c presentExternalUserAgentRequest:session method
        will return NO if the browser isn't installed.
 */
- (nullable instancetype)initWithURLTransformation:(OKTCustomBrowserURLTransformation)URLTransformation;
