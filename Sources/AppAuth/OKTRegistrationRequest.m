...
@implementation OKTRegistrationRequest
...
- (instancetype)initWithConfiguration:(OKTServiceConfiguration *)configuration
  ...
  if (self) {
    ...
    _applicationType = OKTApplicationTypeNative;
  }
  return self;
}
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
  ...
  NSString *tokenEndpointAuthenticationMethod =
      [aDecoder decodeObjectOfClass:[NSString class]
                             forKey:OKTTokenEndpointAuthenticationMethodParam];
...
- (NSData *)JSONString {
  ...
  dict[OKTRedirectURIsParam] = redirectURIStrings;
  dict[OKTApplicationTypeParam] = _applicationType;
  ...
  if (_responseTypes) {
    dict[OKTResponseTypesParam] = _responseTypes;
  }
  if (_grantTypes) {
    dict[OKTGrantTypesParam] = _grantTypes;
  }
  if (_subjectType) {
    dict[OKTSubjectTypeParam] = _subjectType;
  }
  if (_tokenEndpointAuthenticationMethod) {
    dict[OKTTokenEndpointAuthenticationMethodParam] = _tokenEndpointAuthenticationMethod;
  }
