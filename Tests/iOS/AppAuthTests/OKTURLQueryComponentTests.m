/*! @file OKTURLQueryComponentTests.m
...
#import "OKTURLQueryComponentTests.h"
...
@implementation OKTURLQueryComponentTests
...
- (void)test_formurlencoded_decoding {
  ...
  // Tests an encoded scope with a '+'-encoded space
  {
    ...
    OKTURLQueryComponent *query =
        [[OKTURLQueryComponent alloc] initWithURL:[NSURL URLWithString:authorizationResponse]];
...
- (void)test_formurlencoded_encoding {
  ...
  {
    OKTURLQueryComponent *query = [[OKTURLQueryComponent alloc] initWithURL:baseURL];
...
- (void)testBuildingParameterStringWithSimpleParameters {
  ...
  OKTURLQueryComponent *parsedParameters =
      [[OKTURLQueryComponent alloc] initWithURL:rootURLWithParameters];
...
- (void)testParsingQueryString {
  ...
  OKTURLQueryComponent *query = [[OKTURLQueryComponent alloc] initWithURL:URLToParse];
