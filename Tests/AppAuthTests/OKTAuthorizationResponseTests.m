/*! @file OKTAuthorizationResponseTests.m
...
@implementation OKTAuthorizationResponseTests

+ (OKTAuthorizationResponse *)testInstance {
  OKTAuthorizationRequest *request = [OKTAuthorizationRequestTests testInstance];
  OKTAuthorizationResponse *response =
      [[OKTAuthorizationResponse alloc] initWithRequest:request parameters:@{
...
+ (OKTAuthorizationResponse *)testInstanceCodeFlow {
  OKTAuthorizationRequest *request = [OKTAuthorizationRequestTests testInstanceCodeFlow];
  OKTAuthorizationResponse *response =
      [[OKTAuthorizationResponse alloc] initWithRequest:request parameters:@{
        @"code" : kTestAuthorizationCode,
        @"code_verifier" : kTestAuthorizationCodeVerifier,
        @"state" : kTestState,
        @"token_type" : OKTGrantTypeAuthorizationCode,
        kTestAdditionalParameterKey : kTestAdditionalParameterValue
      }];
  return response;
}
...
+ (OKTAuthorizationResponse *)testInstanceCodeFlowClientAuth {
  OKTAuthorizationRequest *request = [OKTAuthorizationRequestTests testInstanceCodeFlowClientAuth];
  OKTAuthorizationResponse *response =
      [[OKTAuthorizationResponse alloc] initWithRequest:request parameters:@{
        @"code" : kTestAuthorizationCode,
        @"code_verifier" : kTestAuthorizationCodeVerifier,
 ...
 */
- (void)testCopying {
  OKTAuthorizationResponse *response = [[self class] testInstance];
  ...
  OKTAuthorizationResponse *responseCopy = [response copy];
...
- (void)testSecureCoding {
  ...
  OKTAuthorizationResponse *responseCopy = [NSKeyedUnarchiver unarchiveObjectWithData:data];
