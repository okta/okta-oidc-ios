...
class OIDExternalUserAgentSessionMock: NSObject, OIDExternalUserAgentSession {

    let signCallback: OIDAuthStateAuthorizationCallback?
    let signOutCallback: OIDEndSessionCallback?
    
    init(signCallback: OIDAuthStateAuthorizationCallback?, signOutCallback: OIDEndSessionCallback?) {
