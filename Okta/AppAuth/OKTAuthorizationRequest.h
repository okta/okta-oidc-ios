/*! @file OKTAuthorizationRequest.h
...
// These files only declare string constants useful for constructing a @c OKTAuthorizationRequest,
 ...
 */
extern NSString *const OKTOAuthorizationRequestCodeChallengeMethodS256;
 ...
 */
@interface OKTAuthorizationRequest :
    NSObject<NSCopying, NSSecureCoding, OKTExternalUserAgentRequest>
...
/*! @brief The PKCE code verifier.
    ...
    @discussion The code verifier itself is not included in the authorization request that is sent
        ...
        @c OKTAuthorizationResponse.tokenExchangeRequest will create a @c OKTTokenRequest that
...
/*! @brief Designated initializer.
    ...
    @param nonce String value used to associate a Client session with an ID Token. Can be set to nil
        ...
        understand anyway.
    @param codeVerifier The PKCE code verifier. See @c OKTAuthorizationRequest.generateCodeVerifier.
    @param codeChallenge The PKCE code challenge, calculated from the code verifier such as with
        @c OKTAuthorizationRequest.codeChallengeS256ForVerifier:.
    @param codeChallengeMethod The PKCE code challenge method.
        ::OKTOAuthorizationRequestCodeChallengeMethodS256 when
        @c OKTAuthorizationRequest.codeChallengeS256ForVerifier: is used to create the code
        challenge.
    @param additionalParameters The client's additional authorization parameters.
 */
- (instancetype)
...
/*! @brief Creates a PKCE S256 codeChallenge from the codeVerifier.
    ...
    @details Generate a secure code verifier to pass into this method with
        @c OKTAuthorizationRequest.generateCodeVerifier. The matching @c #codeChallengeMethod for
        @c #codeChallenge%s created by this method is
        ::OKTOAuthorizationRequestCodeChallengeMethodS256.
    @see https://tools.ietf.org/html/rfc7636#section-4.1
 */
