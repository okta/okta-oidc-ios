/*! @file OKTServiceConfiguration.m
...
@interface OKTServiceConfiguration ()
...
- (instancetype)initWithAuthorizationEndpoint:(NSURL *)authorizationEndpoint
                         ...
                         registrationEndpoint:(nullable NSURL *)registrationEndpoint
                           endSessionEndpoint:(nullable NSURL *)endSessionEndpoint
                            discoveryDocument:(nullable OKTServiceDiscovery *)discoveryDocument
                            NS_DESIGNATED_INITIALIZER;

@end

@implementation OKTServiceConfiguration

- (instancetype)init
    OKT_UNAVAILABLE_USE_INITIALIZER(@selector(
...
- (instancetype)initWithAuthorizationEndpoint:(NSURL *)authorizationEndpoint
        tokenEndpoint:(NSURL *)tokenEndpoint
               issuer:(nullable NSURL *)issuer
 registrationEndpoint:(nullable NSURL *)registrationEndpoint
   endSessionEndpoint:(nullable OKTServiceDiscovery *)endSessionEndpoint
    discoveryDocument:(nullable OKTServiceDiscovery *)discoveryDocument {
...
- (nullable instancetype)initWithCoder:(NSCoder *)aDecoder {
  ...
  OKTServiceDiscovery *discoveryDocument = [aDecoder decodeObjectOfClass:[OKTServiceDiscovery class]
...
- (NSString *)description {
  return [NSString stringWithFormat:
      @"OKTServiceConfiguration authorizationEndpoint: %@, tokenEndpoint: %@, "
