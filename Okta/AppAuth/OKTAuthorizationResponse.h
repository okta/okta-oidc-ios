/*! @file OKTAuthorizationResponse.h
 ...
 */
@interface OKTAuthorizationResponse : NSObject <NSCopying, NSSecureCoding>

/*! @brief The request which was serviced.
 */
@property(nonatomic, readonly) OKTAuthorizationRequest *request;
...
/*! @brief The approximate expiration date & time of the access token.
    @discussion Set when the response_type requested includes 'token'.
    @remarks expires_in
    @seealso OKTAuthorizationResponse.accessToken
    @see http://openid.net/specs/openid-connect-core-1_0.html#ImplicitAuthResponse
 */
...
/*! @brief Creates a token request suitable for exchanging an authorization code for an access
        token.
    @return A @c OKTTokenRequest suitable for exchanging an authorization code for an access
        token.
    @see https://tools.ietf.org/html/rfc6749#section-4.1.3
 */
- (nullable OKTTokenRequest *)tokenExchangeRequest;
...
/*! @brief Creates a token request suitable for exchanging an authorization code for an access
    ...
    @see https://tools.ietf.org/html/rfc6749#section-4.1.3
 */
- (nullable OKTTokenRequest *)tokenExchangeRequestWithAdditionalParameters:
