...
/*! @brief Represents a function which transforms incoming source values into instance variable
        values.
 */
typedef _Nullable id(^OKTFieldMappingConversionFunction)(NSObject *_Nullable value);

/*! @brief Describes the mapping of a key/value pair to an iVar with an optional conversion
        function.
 */
@interface OKTFieldMapping : NSObject
 ...
 */
@property(nonatomic, readonly, nullable) OKTFieldMappingConversionFunction conversion;
...
/*! @brief The designated initializer.
    ...
    @param conversion An optional conversion function which specifies a transform from the incoming
        ...
        @c OKTFieldMapping.remainingParametersWithMap:parameters:instance: but not during
