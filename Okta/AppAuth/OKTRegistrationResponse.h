/*! @file OKTRegistrationResponse.h
 ...
 */
extern NSString *const OKTClientIDParam;

/*! @brief Parameter name for the client id issuance timestamp.
 */
extern NSString *const OKTClientIDIssuedAtParam;

/*! @brief Parameter name for the client secret.
 */
extern NSString *const OKTClientSecretParam;

/*! @brief Parameter name for the client secret expiration time.
 */
extern NSString *const OKTClientSecretExpirestAtParam;

/*! @brief Parameter name for the registration access token.
 */
extern NSString *const OKTRegistrationAccessTokenParam;

/*! @brief Parameter name for the client configuration URI.
 */
extern NSString *const OKTRegistrationClientURIParam;
 ...
 */
@interface OKTRegistrationResponse : NSObject <NSCopying, NSSecureCoding>

/*! @brief The request which was serviced.
 */
@property(nonatomic, readonly) OKTRegistrationRequest *request;
