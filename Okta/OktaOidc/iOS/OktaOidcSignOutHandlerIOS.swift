...
public class OktaOidcSignOutHandlerIOS: OktaOidcSignOutHandler {
    
    var presenter: UIViewController
    
    init(presenter: UIViewController, options: OktaSignOutOptions, oidcClient: OktaOidc, authStateManager: OktaOidcStateManager) {
